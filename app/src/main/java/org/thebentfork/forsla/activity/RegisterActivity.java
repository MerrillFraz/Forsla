...
import org.thebentfork.forsla.app.AppConfig;
import org.thebentfork.forsla.app.AppController;
    ...
    private void registerUser(final String name, final String email,
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                ...
                Log.d(TAG, "End of Register Response...");
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), "User successfully registered. Try logging in.", Toast.LENGTH_LONG).show();
